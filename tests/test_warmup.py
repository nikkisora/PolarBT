...
class TestAutoWarmup:
    ...
    def test_auto_warmup_default(self, sample_data):
    ...
    def test_auto_warmup_calculation_sma_20(self, sample_data):
    ...
    def test_auto_warmup_calculation_sma_50(self, sample_data):
    ...
    def test_auto_warmup_no_indicators(self, sample_data):
    ...
    def test_auto_warmup_multiple_indicators(self, sample_data):
    ...
    def test_auto_warmup_excludes_timestamp(self, sample_data):
...
class TestWarmupExecution:
    ...
    def test_manual_warmup_execution(self, sample_data):
    ...
    def test_zero_warmup_execution(self, sample_data):
    ...
    def test_no_indicators_starts_immediately(self, sample_data):
    ...
    def test_execution_count_with_warmup(self, sample_data):
...
class TestWarmupValidation:
    ...
    def test_valid_auto_string(self, sample_data):
        """Test that 'auto' is accepted."""
        strategy = TrackingStrategy()
        engine = Engine(strategy, sample_data, warmup="auto")
        assert engine.warmup == "auto"

    def test_valid_integer(self, sample_data):
        """Test that integer values are accepted."""
        strategy = TrackingStrategy()
        engine = Engine(strategy, sample_data, warmup=10)
        assert engine.warmup == 10

    def test_invalid_string_rejected(self, sample_data):
    ...
    def test_float_rejected(self, sample_data):
        """Test that float values are rejected."""
        strategy = TrackingStrategy()
        with pytest.raises(ValueError, match="warmup must be an integer or 'auto'"):
            Engine(strategy, sample_data, warmup=3.14)

    def test_none_rejected(self, sample_data):
        """Test that None is rejected."""
        strategy = TrackingStrategy()
        with pytest.raises(ValueError, match="warmup must be an integer or 'auto'"):
            Engine(strategy, sample_data, warmup=None)


class TestWarmupWithBacktest:
    """Test warmup through the backtest() function."""

    def test_backtest_auto_warmup_default(self, sample_data):
...
class TestWarmupEdgeCases:
    ...
    def test_warmup_larger_than_data(self, sample_data):
    ...
    def test_all_null_indicators(self):
    ...
    def test_partial_null_data(self):
...
class TestWarmupWithMultiAsset:
    ...
    def test_multi_asset_auto_warmup(self):
...
class TestWarmupIntegration:
    ...
    def test_strategy_without_none_checks(self, sample_data):
    ...
    def test_strategy_with_manual_warmup_needs_checks(self, sample_data):
    ...
    def test_warmup_consistency_across_runs(self, sample_data):
