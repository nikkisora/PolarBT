"""Optional TA-Lib integration for PolarBtest.
...
# ---------------------------------------------------------------------------
# Convenience wrappers — mirror the polarbtest.indicators API
# ---------------------------------------------------------------------------
...
class TALibIndicators:
    ...
    ``polarbtest.indicators`` so you can swap implementations easily.
